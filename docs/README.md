...
- `mission.md` explains the paper mission, audit vision, release model, and adoption plan.
- `agent-native-standard.md` is the operating standard for agent-first repositories.
- `audit-rubric.md` defines the codebase audit, vibe-coding hard rules, and CI expectations.
