...
if ! "$jankurai_cmd" gate .; then
  echo "jankurai pre-commit gate failed; set JANKURAI_SKIP_HOOKS=1 to bypass local hooks" >&2
  exit 1
fi
...
pub const TEMPLATES: &[Template] = &[
    ...
    Template {
        ...
        body: include_str!("../../templates/agent/badge.toml"),
    },
    Template {
    ...
    Template {
        ...
        body: include_str!("../../templates/github-workflows/jankurai.yml"),
    }
];
