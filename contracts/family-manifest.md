...
of a fused release depends on. The contract has two committed sources of truth:
...
then run `just fast`. A release promotes the validated manifest + lock pair as
the fused-release bill of materials (see [`../docs/release.md`](../docs/release.md)).
