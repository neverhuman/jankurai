...
jobs:
  audit:
    ...
    steps:
      ...
      - uses: neverhuman/jankurai@v1.0.0
        with:
          mode: advisory
...
- **Total `#[test]` functions:** 578 across the Rust workspace
...
Current release: standard `0.8.0`, auditor/action `1.0.0`, schema `1.7.0`, paper edition `2026.05-ed8`.
